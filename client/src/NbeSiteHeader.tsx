...
export default function NbeSiteHeader({ lang, onLanguageChange, menuOpen = false, onMenuToggle, loginLabel, menuLabel, collectionLabel, orderLabel, adminLabel }: NbeSiteHeaderProps) {
  const isAr = lang === "ar";
  return <header className="official-login-header site-shared-header">
    ...
    <div className="official-login-header-actions">
      <Link href="/login" className="site-header-login-link">{loginLabel}</Link>
